# ApproxCopula reproducibility 

Note: Our package has been renamed from QuasiCopula.jl to [ApproxCopula](https://github.com/OpenMendel/ApproxCopula.jl)

Scripts to reproduce the experiments performed for the [ApproxCopula](https://github.com/OpenMendel/ApproxCopula.jl) manuscript:
